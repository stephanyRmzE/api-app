...
class JourneysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create journey" do
    assert_difference('Journey.count') do
      post journeys_url, params: { journey: { car_id: @journey.car_id, people: @journey.people } }, as: :json
    end
  ...
  test "should update journey" do
    patch journey_url(@journey), params: { journey: { car_id: @journey.car_id, people: @journey.people } }, as: :json
    assert_response 200
  end
